...
# 
kde_version_parts = '4.14.3'.split('.')
...
_pkg_config = {
    ...
    'konsolepart':          'False',
    'libdir':               'lib',
    'pykde_kde_sip_flags':  ' -t ALL -t WS_X11 -t Qt_4_8_6  -X VendorID -X PyQt_NoPrintRangeBug -P;-g;-x;PyKDE_QVector;-x;PyKDE_GLuint',
    'pykde_mod_dir':        '/usr/lib/python3.4/site-packages/PyKDE4',
    'pykde_modules':        '',
    'pykde_sip_dir':        '/usr/share/python3-sip/PyKDE4',

...
_pkg_config = {
    ...
    'sip_config_args':    '-p cygwin-g++ -b /usr/lib/python2.7/site-packages -d /usr/lib/python2.7/site-packages -e /usr/include/python2.7 -v /usr/share/python-sip CFLAGS+=-ggdb -O2 -pipe -Wimplicit-function-declaration -fdebug-prefix-map=/usr/src/ports/python-sip/python-sip-4.16.9-1.x86_64/build=/usr/src/debug/python-sip-4.16.9-1 -fdebug-prefix-map=/usr/src/ports/python-sip/python-sip-4.16.9-1.x86_64/src/sip-4.16.9=/usr/src/debug/python-sip-4.16.9-1 CXXFLAGS+=-ggdb -O2 -pipe -fdebug-prefix-map=/usr/src/ports/python-sip/python-sip-4.16.9-1.x86_64/build=/usr/src/debug/python-sip-4.16.9-1 -fdebug-prefix-map=/usr/src/ports/python-sip/python-sip-4.16.9-1.x86_64/src/sip-4.16.9=/usr/src/debug/python-sip-4.16.9-1',
...
_default_macros = {
    ...
    'AR':                       'ar cqs',
    'CC':                       'gcc',
    'CFLAGS':                   '-pipe -ggdb -O2 -pipe -Wimplicit-function-declaration -fdebug-prefix-map=/usr/src/ports/python-sip/python-sip-4.16.9-1.x86_64/build=/usr/src/debug/python-sip-4.16.9-1 -fdebug-prefix-map=/usr/src/ports/python-sip/python-sip-4.16.9-1.x86_64/src/sip-4.16.9=/usr/src/debug/python-sip-4.16.9-1',
    'CFLAGS_APP':               '',
    'CFLAGS_CONSOLE':           '',
    'CFLAGS_DEBUG':             '-g',
    ...
    'COPY':                     'cp -f',
    'CXX':                      'g++',
    'CXXFLAGS':                 '-pipe -ggdb -O2 -pipe -fdebug-prefix-map=/usr/src/ports/python-sip/python-sip-4.16.9-1.x86_64/build=/usr/src/debug/python-sip-4.16.9-1 -fdebug-prefix-map=/usr/src/ports/python-sip/python-sip-4.16.9-1.x86_64/src/sip-4.16.9=/usr/src/debug/python-sip-4.16.9-1',
    'CXXFLAGS_APP':             '',
    'CXXFLAGS_CONSOLE':         '',
    'CXXFLAGS_DEBUG':           '-g',

...
TCL_EXTRA_CFLAGS='-ggdb -O2 -pipe -Wimplicit-function-declaration -fdebug-prefix-map=/usr/src/ports/tcl/tcl-8.5.18-1.x86_64/build=/usr/src/debug/tcl-8.5.18-1 -fdebug-prefix-map=/usr/src/ports/tcl/tcl-8.5.18-1.x86_64/src/tcl8.5.18=/usr/src/debug/tcl-8.5.18-1 -pipe '

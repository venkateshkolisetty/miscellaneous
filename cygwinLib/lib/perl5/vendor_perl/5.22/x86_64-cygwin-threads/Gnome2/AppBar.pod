...
=item 'has-progress' (boolean : default false : readable / writable / construct)

Create a progress widget.

=item 'has-status' (boolean : default false : readable / writable / construct)

Create a status widget.

=item 'interactivity' (Gnome2::PreferencesType : default "never" : readable / writable / construct)

...
=item 'orientation' (Gtk2::Orientation : default "horizontal" : readable / writable)

Orientation

=item 'preferred-height' (Glib::UInt : default 0 : readable)

Preferred height

=item 'preferred-width' (Glib::UInt : default 0 : readable)

Preferred width

=item 'shadow' (Gtk2::ShadowType : default "out" : readable / writable)

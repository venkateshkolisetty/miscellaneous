...
=item 'authors' (GValueArray : default undef : writable)

List of authors of the programs

=item 'comments' (string : default undef : readable / writable)

Comments about the program

=item 'copyright' (string : default undef : readable / writable)

Copyright information for the program

=item 'documenters' (GValueArray : default undef : writable)

List of people documenting the program

=item 'logo' (Gtk2::Gdk::Pixbuf : default undef : writable)

A logo for the about box

=item 'name' (string : default undef : readable / writable)

The name of the program

=item 'translator-credits' (string : default undef : readable / writable)

Credits to the translators. This string should be marked as translatable

=item 'version' (string : default undef : readable / writable)

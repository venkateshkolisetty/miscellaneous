...
=item 'height-in-pixels' (boolean : default false : readable / writable)

=item 'height-set' (boolean : default false : readable / writable)

=item 'pixbuf' (Gtk2::Gdk::Pixbuf : default undef : readable / writable)

=item 'width' (double : default 0 : readable / writable)

=item 'width-in-pixels' (boolean : default false : readable / writable)

=item 'width-set' (boolean : default false : readable / writable)

=item 'x' (double : default 0 : readable / writable)

=item 'x-in-pixels' (boolean : default false : readable / writable)

=item 'y' (double : default 0 : readable / writable)

=item 'y-in-pixels' (boolean : default false : readable / writable)

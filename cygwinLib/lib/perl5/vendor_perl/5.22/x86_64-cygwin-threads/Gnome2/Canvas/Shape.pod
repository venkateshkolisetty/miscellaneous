...
=item 'cap-style' (Gtk2::Gdk::CapStyle : default "butt" : readable / writable)

=item 'dash' (gpointer : default 0 : readable / writable)
...
=item 'join-style' (Gtk2::Gdk::JoinStyle : default "miter" : readable / writable)

=item 'miterlimit' (double : default 0 : readable / writable)

=item 'outline-color' (string : default undef : writable)

=item 'outline-color-gdk' (Gtk2::Gdk::Color : default undef : readable / writable)

=item 'outline-color-rgba' (Glib::UInt : default 0 : readable / writable)

=item 'outline-stipple' (Gtk2::Gdk::Drawable : default undef : readable / writable)

=item 'width-pixels' (Glib::UInt : default 0 : readable / writable)

=item 'width-units' (double : default 0 : readable / writable)

=item 'wind' (Glib::UInt : default 0 : readable / writable)

...
=head2 bus = GStreamer::Bus-E<gt>B<new> 

=head2 $bus-E<gt>B<add_signal_watch> 

=head2 integer = $bus-E<gt>B<add_watch> ($func, $data=undef)
...
=head2 $bus-E<gt>B<set_flushing> ($flushing)

=over

=item * $flushing (boolean) 

=back

=head2 boolean = $bus-E<gt>B<have_pending> 

=head2 GstMessage or undef = $bus-E<gt>B<peek> 

=head2 GstMessage or undef = $bus-E<gt>B<poll> ($events, $timeout)

=over

=item * $events (GStreamer::MessageType) 

=item * $timeout (integer) 

=back

=head2 GstMessage or undef = $bus-E<gt>B<pop> 

=head2 boolean = $bus-E<gt>B<post> ($message)
...
=head2 $bus-E<gt>B<remove_signal_watch> 
...
=item B<sync-message> (GStreamer::Bus, GstMessage)

=item B<message> (GStreamer::Bus, GstMessage)

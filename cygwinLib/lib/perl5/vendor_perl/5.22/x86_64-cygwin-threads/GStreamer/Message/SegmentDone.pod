...
=head2 GstMessage = GStreamer::Message::SegmentDone-E<gt>B<new> ($src, $format, $position)
...
=item * $position (64 bit integer) 

=back

=head2 scalar = $message-E<gt>B<format> 

=head2 scalar = $message-E<gt>B<position> 

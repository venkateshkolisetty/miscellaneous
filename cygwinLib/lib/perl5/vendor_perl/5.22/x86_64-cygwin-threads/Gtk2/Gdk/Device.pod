...
=head2 axisuse = $device-E<gt>B<get_axis_use> ($index)
...
=head2 (keyval, modifiers) = $device-E<gt>B<get_key> ($index)
...
=head2 inputmode = $device-E<gt>B<get_mode> 
...
=head2 integer = $device-E<gt>B<get_n_axes> 

Since: gtk+ 2.22

=head2 string = $device-E<gt>B<name> 

=head2 string = $device-E<gt>B<get_name> 

Since: gtk+ 2.22

=head2 inputsource = $device-E<gt>B<source> 

=head2 inputsource = $device-E<gt>B<get_source> 

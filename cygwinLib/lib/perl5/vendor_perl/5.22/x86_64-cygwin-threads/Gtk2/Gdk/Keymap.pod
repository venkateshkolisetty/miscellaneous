...
=head2 modifiertype = $keymap-E<gt>B<add_virtual_modifiers> ($state)
...
=head2 boolean = $keymap-E<gt>B<get_caps_lock_state> 
...
=head2 (bool, new_state) = $keymap->B<map_virtual_modifiers> (keymap, state)

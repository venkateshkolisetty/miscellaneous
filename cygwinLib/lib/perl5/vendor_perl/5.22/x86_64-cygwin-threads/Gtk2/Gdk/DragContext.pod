...
=head2 dragaction = $context-E<gt>B<get_actions> 
...
=head2 list = $context-E<gt>B<list_targets> 
...
=head2 dragaction = $context-E<gt>B<get_selected_action> 
...
=head2 window = $context-E<gt>B<get_source_window> 
...
=head2 dragaction = $context-E<gt>B<get_suggested_action> 

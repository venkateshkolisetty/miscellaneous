...
=head2 string or undef = Gtk2::Window-E<gt>B<get_default_icon_name> 
...
=head2 boolean = $window-E<gt>B<has_group> 
...
=head2 boolean = $window-E<gt>B<get_mnemonics_visible> 

Since: gtk+ 2.20

=head2 $window-E<gt>B<set_mnemonics_visible> ($setting)

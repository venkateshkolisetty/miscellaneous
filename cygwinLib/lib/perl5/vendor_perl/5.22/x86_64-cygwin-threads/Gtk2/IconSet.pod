...
=head2 iconset = Gtk2::IconSet-E<gt>B<new> 

=head2 iconset = Gtk2::IconSet-E<gt>B<new_from_pixbuf> ($pixbuf)
...
=head2 $icon_set-E<gt>B<add_source> ($source)
...
=head2 pixbuf = $icon_set-E<gt>B<render_icon> ($style, $direction, $state, $size, $widget, $detail=undef)
...
=head2 list = $icon_set-E<gt>B<get_sizes> 

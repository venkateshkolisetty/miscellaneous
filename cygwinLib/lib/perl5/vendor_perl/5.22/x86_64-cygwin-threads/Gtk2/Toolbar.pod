...
=item 'icon-size' (integer : default 3 : readable / writable / private)
...
=item 'show-arrow' (boolean : default true : readable / writable / private)

If an arrow should be shown if the toolbar doesn't fit

=item 'toolbar-style' (Gtk2::ToolbarStyle : default "both" : readable / writable / private)

How to draw the toolbar

=item 'tooltips' (boolean : default true : readable / writable / private)
...
=item 'button-relief' (Gtk2::ReliefStyle : default "none" : readable / private)

Type of bevel around toolbar buttons

=item 'internal-padding' (integer : default 0 : readable / private)

Amount of border space between the toolbar shadow and the buttons

=item 'max-child-expand' (integer : default INT_MAX : readable / private)

Maximum amount of space an expandable item will be given

=item 'shadow-type' (Gtk2::ShadowType : default "out" : readable / private)

Style of bevel around the toolbar

=item 'space-size' (integer : default 12 : readable / private)

Size of spacers

=item 'space-style' (Gtk2::ToolbarSpaceStyle : default "line" : readable / private)

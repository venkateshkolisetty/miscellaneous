...
=head2 (xalign, yalign) = $cell-E<gt>B<get_alignment> 

Since: gtk+ 2.18

=head2 $cell-E<gt>B<set_alignment> ($xalign, $yalign)
...
=head2 (xpad, ypad) = $cell-E<gt>B<get_padding> 

Since: gtk+ 2.18

=head2 $cell-E<gt>B<set_padding> ($xpad, $ypad)
...
=head2 boolean = $cell-E<gt>B<get_sensitive> 

Since: gtk+ 2.18

=head2 $cell-E<gt>B<set_sensitive> ($sensitive)
...
=head2 boolean = $cell-E<gt>B<get_visible> 

Since: gtk+ 2.18

=head2 $cell-E<gt>B<set_visible> ($visible)

...
=head2 boolean = $expander-E<gt>B<get_label_fill> 

Since: gtk+ 2.22

=head2 $expander-E<gt>B<set_label_fill> ($label_fill)

=over

=item * $label_fill (boolean) 
...
=item 'expander-size' (integer : default 10 : readable / private)

Size of the expander arrow

=item 'expander-spacing' (integer : default 2 : readable / private)

...
=item 'secondary' (boolean : default false : readable / writable / private)
...
=item 'child-internal-pad-x' (integer : default 4 : readable / private)

Amount to increase child's size on either side

=item 'child-internal-pad-y' (integer : default 0 : readable / private)

Amount to increase child's size on the top and bottom

=item 'child-min-height' (integer : default 27 : readable / private)

Minimum height of buttons inside the box

=item 'child-min-width' (integer : default 85 : readable / private)
